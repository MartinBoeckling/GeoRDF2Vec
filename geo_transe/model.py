...
class Train:
    def __init__(self):
        ...
        self.result_path = f"./datasets/{self.dataset}/result/"
        self.log_path = f"./logs/iswc_train_for_context_preservation_on_{self.dataset}.log"
        ...
        self.norm = 2
        self.entity_dimension = 200
        self.relation_dimension = 200
