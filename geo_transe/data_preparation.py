...
class DataPreparation:
    def __init__(self):
        ...
        self.log_path = f"./logs/data_preparation_on_{self.dataset}.log"
    ...
    def read_dataset(self):
        ...
        for index in range(3):
            ...
            with open(self.input_path + name + ".txt", "r+") as data_reader:
                ...
                while tmp_line and tmp_line not in ["\n", "\r\n", "\r"]:
                    ...
                    tmp_line = data_reader.readline()
                dump_data(string_triple, self.output_path + f"string_{name}_triples.pickle", self.log_path, f"string_{name}_triples")
                dump_data(id_triple, self.output_path + f"id_{name}_triples.pickle", self.log_path, f"id_{name}_triples")
